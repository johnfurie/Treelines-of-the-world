...
# smooth chm
chm_tree <- CHMsmoothing(chm_tree, filter = "Gaussian", ws = 69)
chm_shrub <- CHMsmoothing(chm_shrub, filter = "Gaussian", ws = 69)
chm_tree_shrub <- CHMsmoothing(chm_tree_shrub, filter = "Gaussian", ws = 69)
...
#Write shape
writeOGR(pt, file.path(envrmt$path_002_processed, "ft_tpos_t_f69.shp"),layer="testShape",driver="ESRI Shapefile")
pt<-  rgdal::readOGR(file.path(envrmt$path_002_processed, "ft_tpos_t_f69.shp"))
...
#Write shape
writeOGR(ps, file.path(envrmt$path_002_processed, "ft_tpos_s_f69.shp"),layer="testShape",driver="ESRI Shapefile")
ps<-  rgdal::readOGR(file.path(envrmt$path_002_processed, "ft_tpos_s_f69.shp"))
...
writeOGR(pts, file.path(envrmt$path_002_processed, "ft_tpos_ts_f69.shp"),layer="testShape",driver="ESRI Shapefile")
pts<-  rgdal::readOGR(file.path(envrmt$path_002_processed, "ft_tpos_ts_f69.shp"))
