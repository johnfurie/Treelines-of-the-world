...
#Write shape
writeOGR(pt, file.path(envrmt$path_002_processed, "ft_tpos_t_f5.shp"),layer="testShape",driver="ESRI Shapefile")
pt<-  rgdal::readOGR(file.path(envrmt$path_002_processed, "ft_tpos_t_f5.shp"))
...
#Write shape
writeOGR(ps, file.path(envrmt$path_002_processed, "ft_tpos_s_f5.shp"),layer="testShape",driver="ESRI Shapefile")
ps<-  rgdal::readOGR(file.path(envrmt$path_002_processed, "ft_tpos_s_f5.shp"))
...
writeOGR(pts, file.path(envrmt$path_002_processed, "ft_tpos_ts_f5.shp"),layer="testShape",driver="ESRI Shapefile")
pts<-  rgdal::readOGR(file.path(envrmt$path_002_processed, "ft_tpos_ts_f5.shp"))
