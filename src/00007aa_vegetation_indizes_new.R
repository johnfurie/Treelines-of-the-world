...
# write
writeRaster(all_stk, file.path(envrmt$path_002_processed,"veg_ind_new31.tif"),format="GTiff",overwrite=TRUE)
all_stk       <- raster::stack(file.path(envrmt$path_002_processed, "veg_ind_new3.tif"))
