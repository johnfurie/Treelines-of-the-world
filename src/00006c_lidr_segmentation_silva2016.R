...
#tree
# segmentation
lasts_t   <- segment_trees(las_ts, silva2016(
  chm =chm_tree_shrub, 
...
#write data
writeOGR(poly_ts_t, file.path(envrmt$path_002_processed, "lidr_seg_sil_ts_t.shp"),layer="testShape",driver="ESRI Shapefile")
seg_ts_t   <-  rgdal::readOGR(file.path(envrmt$path_002_processed,"lidr_seg_sil_ts_t.shp"))
...
#shrub
# segmentation
lasts_s   <- segment_trees(las_ts, silva2016(
  chm =chm_tree_shrub, 
...
#write data
writeOGR(poly_ts_s, file.path(envrmt$path_002_processed, "lidr_seg_sil_ts_s.shp"),layer="testShape",driver="ESRI Shapefile")
seg_ts_s   <-  rgdal::readOGR(file.path(envrmt$path_002_processed,"lidr_seg_sil_ts_s.shp"))
